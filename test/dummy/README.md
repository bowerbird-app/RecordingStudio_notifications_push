...
- FlatPack sidebar shell, assets, and Tailwind source scanning
...
Authenticated pages use the FlatPack sidebar layout (`flat_pack_sidebar`). Devise sign-in keeps `layouts/application`. Replace dummy docs page content so it matches the gem's actual concepts.
